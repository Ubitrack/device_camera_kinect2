device_camera_kinect2
==============
This is the Ubitrack device_camera_kinect2 submodule.

Description
----------
The device_camera_kinect2 contains components for video capturing with the Microsoft Kinect2 SDK.
...
If you handle multiple dependencies in your project is better to add a *conanfile.txt*
    ...
    [requires]
    ubitrack_device_camera_kinect2/1.3.0@ubitrack/stable
...
## Upload
    ...
    $ conan upload -r camp ubitrack_device_camera_kinect2/1.3.0@ubitrack/stable
